...
% **SGML with LSML objective value and running time experiments
%
% author: Cheng Yang
...
options.ConstraintTolerance = 1e-4; % except fourclass using 1e-5
...
elseif dataset_i==4
    ...
    options.ConstraintTolerance = 1e-5; % except fourclass using 1e-5
elseif dataset_i==5
