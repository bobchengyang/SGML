...
addpath('F:\18-JUN-2020 SGML\SGML_with_MCML_DEML_LSML_LMNN_GLR\different_objectives_old_source\dataset\'); %dataset
addpath('competing_scheme\Wei\'); %Wei
addpath('competing_scheme\PD_cone\'); %PD cone
addpath('competing_scheme\LMNN\'); %LMNN

disp('1. PD-cone projection');
disp('2. HBNB projection');
disp('3. SGML');
user_entry = input('please kindly choose 1 out of the above 3 optimization scheme to run:', 's');
