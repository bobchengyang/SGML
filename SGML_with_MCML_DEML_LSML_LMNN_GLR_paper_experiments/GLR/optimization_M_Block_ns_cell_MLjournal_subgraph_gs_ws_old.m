...
options = optimoptions('linprog','Display','none','Preprocess','none','Algorithm','dual-simplex');
...
%         end
    ...
    tic;
    [ G ] = optimization_M_set_gradient( partial_sample, feature_N, c, M_temp_best, y, nv, BCD);
