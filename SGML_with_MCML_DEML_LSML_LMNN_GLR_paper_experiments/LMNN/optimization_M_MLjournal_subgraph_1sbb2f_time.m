...
for time_i=1:run_t
    ...
    [targets_ind,same_label,G_ready] = lmnn_get_variables_ready(partial_feature,n_feature,partial_sample,partial_observation);
...
%             league_vec0=league_vec;
    ...
    for BCD = 1:n_feature
        ...
        %if flag==0
        [G] = lmnn_gradient([2*G_ready(BCD,remaining_idx) diag(G_ready)'],targets_ind,...
            same_label,...
            M,...
            partial_feature,...
            partial_sample,...
