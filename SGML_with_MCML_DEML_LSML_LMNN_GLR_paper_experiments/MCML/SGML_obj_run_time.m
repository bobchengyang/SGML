...
for time_i=1:run_t
    ...
    for BCD = 1:n_feature
        ...
        [M_blue,...
            ...
            lu_bound_idx,...
            options,...
            Q_blue] = optimization_M_Block_ns_cell_MLjournal_subgraph_gs_ws(1,league_vec,league_vec_temp,league_vec_remaining,...
            scaled_factors_h,...
            Ms_off_diagonal,...
            n_feature,...
            G,...
        ...
        [M_red,...
            ...
            bins_red,...
            num_list_red,...
            Q_red] = optimization_M_Block_ns_cell_MLjournal_subgraph_gs_ws2(-1,league_vec,league_vec_temp,league_vec_remaining,...
            scaled_factors_h,...
            n_feature,...
            G,...
            M,...
