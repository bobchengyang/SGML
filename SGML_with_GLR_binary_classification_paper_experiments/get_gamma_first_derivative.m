...
% **get the first derivative of Q(M) w.r.t. gamma
%
% author: Cheng Yang
...
%=================================================================
function [G1] = get_gamma_first_derivative(...
    M_previous,...
    gamma,...
...
% replace the following function if you need to run SGML on a different
% objective function from GLR
[ G1 ] = gamma_first_derivative( partial_sample, feature_N, c, M_lc, y, nv, BCD, remaining_idx, t_M21_solution_previous.*zero_mask, zz );
G1=sum(G1(:));
end
