function [blockVectorX,lambda] = ...
    optimization_M_lobpcg(blockVectorX,operatorA,varargin)
% [blockVectorX,lambda,varargout] = ...
%     optimization_M_lobpcg(blockVectorX,operatorA,varargin)
...
%     在不输入preconditioner的时候怎么确定具体的作用
%
...
%   orthogonal complement of the column-space of blockVectorY. % Y
%   的正交补空间的列空间计算？
%
...
% just a column vector. % 如果研究的是矩阵函数的分解，原来的矩阵函数必须支持矩阵
%
...
% %没有preconditioning 的关键在哪儿，那和eigs的区别在哪儿
...
% end
%先找到前面的特征向量，再在之前的特征向量空间的列空间随机优化，对于多个特征值需要
